...
import (
	...
	"github.com/scottwcode/go-bnb-bookings/internal/handlers"
...
func run() (*driver.DB, error) {
	...
	dbPass := flag.String("dbpass", "", "Database passwd")
	...
	if *dbName == "" || *dbUser == "" {
		fmt.Println("Missing required command line flags")
		os.Exit(1)
	}
	...
	// db, err := driver.ConnectSQL("host=localhost port=5432 dbname=go-bnb-bookings user=scott7 password=")
