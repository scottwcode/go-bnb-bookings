...
import (
	...
	"github.com/scottwcode/go-bnb-bookings/internal/driver"
	"github.com/scottwcode/go-bnb-bookings/internal/forms"
	...
	"github.com/scottwcode/go-bnb-bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	// send email notification to guest with date range of reservation
	htmlMessage := fmt.Sprintf(`
		<strong>Reservation Confirmation</strong><br>
		Dear %s, <br>
		This is to confirm your reservation from %s to %s at the Best Bed and Breakfast.<br> 
	...
	// send email notification to property owner with reserved room and date range
	htmlMessage = fmt.Sprintf(`
		<strong>Reservation Notificaiton</strong><br>
		A reservation has been made for %s from %s to %s at the Best Bed and Breakfast.<br> 
	...
	msg = models.MailData{
		To:      "me@here.com",
		From:    "me@here.com",
		Subject: "Test Reservation Notification",
		Content: htmlMessage,
	}
